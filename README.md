...
## 1. Récupération du code des modules
  ...
  a. Choisissez un emplacement sur votre ordinateur et saisissez la commande suivante dans un terminal :
    ...
    git clone https://github.com/dwaps/begin-with-java

OU BIEN,

  b. Télécharger l'archive zip [https://github.com/dwaps/begin-with-java/archive/master.zip](https://github.com/dwaps/begin-with-java/archive/master.zip). Il vous suffira ensuite de la décompresser ou vous voulez pour travailler.


## 2. Utilisation
Pour atteindre un TP en particulier, utilisez la commande  suivie de l'étiquette du TP. Chez DWAPS, une étiquette de TP est toujours représentée de cette façon :
